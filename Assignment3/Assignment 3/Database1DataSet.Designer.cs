...
namespace Assignment_3 {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class CustomersDataTable : global::System.Data.TypedTableBase<CustomersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public CustomersRow AddCustomersRow(string FirstName, string LastName, string StreetNumber, string Street, string City, string Province, string Country, string PostalCode, string PhoneNumber, string EmailAddress) {
            ...
            private void InitClass() {
                ...
                this.columnStreetNumber.MaxLength = 25;
        ...
        public partial class CustomersRow : global::System.Data.DataRow {
            ...
            public string StreetNumber {
                get {
                    return ((string)(this[this.tableCustomers.StreetNumberColumn]));
                }
                set {
                    this[this.tableCustomers.StreetNumberColumn] = value;
                }
            }
...
namespace Assignment_3.Database1DataSetTableAdapters {
    ...
    public partial class CustomersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Customers] WHERE (([CustomerID] = @Original_CustomerID) AND ([FirstName] = @Original_FirstName) AND ([LastName] = @Original_LastName) AND ([StreetNumber] = @Original_StreetNumber) AND ([Street] = @Original_Street) AND ([City] = @Original_City) AND ([Province] = @Original_Province) AND ([Country] = @Original_Country) AND ([PostalCode] = @Original_PostalCode) AND ([PhoneNumber] = @Original_PhoneNumber) AND ([EmailAddress] = @Original_EmailAddress))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Customers] ([FirstName], [LastName], [StreetNumber], [Street], [City], [Province], [Country], [PostalCode], [PhoneNumber], [EmailAddress]) VALUES (@FirstName, @LastName, @StreetNumber, @Street, @City, @Province, @Country, @PostalCode, @PhoneNumber, @EmailAddress);
SELECT CustomerID, FirstName, LastName, StreetNumber, Street, City, Province, Country, PostalCode, PhoneNumber, EmailAddress FROM Customers WHERE (CustomerID = SCOPE_IDENTITY())";
...
SELECT CustomerID, FirstName, LastName, StreetNumber, Street, City, Province, Country, PostalCode, PhoneNumber, EmailAddress FROM Customers WHERE (CustomerID = @CustomerID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Assignment_3.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CustomerID, FirstName, LastName, StreetNumber, Street, City, Province, Cou" +
                "ntry, PostalCode, PhoneNumber, EmailAddress FROM dbo.Customers";
        ...
        public virtual int Delete(int Original_CustomerID, string Original_FirstName, string Original_LastName, string Original_StreetNumber, string Original_Street, string Original_City, string Original_Province, string Original_Country, string Original_PostalCode, string Original_PhoneNumber, string Original_EmailAddress) {
            ...
            if ((Original_StreetNumber == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[3].Value = ((string)(Original_StreetNumber));
            }
        ...
        public virtual int Insert(string FirstName, string LastName, string StreetNumber, string Street, string City, string Province, string Country, string PostalCode, string PhoneNumber, string EmailAddress) {
            if ((FirstName == null)) {
        ...
        public virtual int Update(
                    ...
                    string Original_PhoneNumber, 
                    string Original_EmailAddress) {
            return this.Update(FirstName, LastName, StreetNumber, Street, City, Province, Country, PostalCode, PhoneNumber, EmailAddress, Original_CustomerID, Original_FirstName, Original_LastName, Original_StreetNumber, Original_Street, Original_City, Original_Province, Original_Country, Original_PostalCode, Original_PhoneNumber, Original_EmailAddress, Original_CustomerID);
        }
    }
